...
public class Main17 {
    ...
    private static void writeFile(String txt, File path) {
        try (FileWriter flw = new FileWriter(path);) {
            flw.write(txt);
        } catch (IOException e) {
            e.printStackTrace();
